<template><h1 id="webpack基础" tabindex="-1"><a class="header-anchor" href="#webpack基础" aria-hidden="true">#</a> webpack基础</h1>
...
<h3 id="开始使用" tabindex="-1"><a class="header-anchor" href="#开始使用" aria-hidden="true">#</a> 开始使用</h3>
<h4 id="_1-资源目录" tabindex="-1"><a class="header-anchor" href="#_1-资源目录" aria-hidden="true">#</a> 1. 资源目录</h4>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>webpack_code # 项目根目录（所有指令必须在这个目录运行）
    └── src # 项目源码目录
        ...
        │   └── sum.js
        └── main.js # 项目主文件
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h4 id="_2-创建文件" tabindex="-1"><a class="header-anchor" href="#_2-创建文件" aria-hidden="true">#</a> 2. 创建文件</h4>
<h5 id="_1" tabindex="-1"><a class="header-anchor" href="#_1" aria-hidden="true">#</a> （1）</h5>
<h5 id="_2" tabindex="-1"><a class="header-anchor" href="#_2" aria-hidden="true">#</a> （2）</h5>
<h5 id="_3" tabindex="-1"><a class="header-anchor" href="#_3" aria-hidden="true">#</a> （3）</h5>
<h5 id="_4" tabindex="-1"><a class="header-anchor" href="#_4" aria-hidden="true">#</a> （4）</h5>
<ul>
<li>count.js</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><h4 id="_3-下载依赖" tabindex="-1"><a class="header-anchor" href="#_3-下载依赖" aria-hidden="true">#</a> 3. 下载依赖</h4>
